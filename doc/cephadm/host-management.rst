...
This can potentialy cause data loss as osds will be forcefully purged from the cluster.
Services specs that still contain this host should be manually updated.
